  ...
  fetchFlights(o, d) {
    ...
    axios(SERVER_URL).then((result) => {
      ...
      if (o === "Meow" && d === "Meow-Meow") {
        cat_gif =
          "https://media3.giphy.com/media/lVBqPM2S0x3y0/giphy.gif?cid=ecf05e47zvz0js96fz81qz5b96gj5ld5jibnh77xfht7apbq&rid=giphy.gif&ct=g";
      }
      ...
      {props.flights.map((f) => (
        <ul>
          <li key={f.id}>
            ...
            .<img src={props.cat_gif} alt="Meow"></img>
          </li>
        </ul>
      ))}
    </div>
